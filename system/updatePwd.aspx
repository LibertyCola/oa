    ...
    <body style="background-image: url(../image/rightFrame.gif)">
        <form id="form1" runat="server">
            <div>
                ...
                <br />
                <br />
                <table class="css" style="border-bottom: #009900 1px solid; border-left: #009900 1px solid; border-right: #009900 1px solid; border-top: #009900 1px solid; height: 51px; width: 261px;" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="height: 25px; width: 80px;" align="right">
                            职员：</td>
                        <td colspan="2" style="height: 25px">
                            <asp:Label ID="Label1" runat="server" CssClass="cssTitle" Text="Label" Width="144px"></asp:Label></td>
                    </tr>
                    <tr>
                        <td style="height: 26px; width: 80px;" align="right">
                            新密码：</td>
