    ...
    <body style="background-image: url(../../image/rightFrame.gif)" class="css">
        <form id="form1" runat="server">
            <div>
                ...
                <br />
                <br />
                <table id="TABLE1" class="css" style="border-bottom: #00cc00 1px solid; border-left: #00cc00 1px solid; border-right: #00cc00 1px solid; border-top: #00cc00 1px solid; height: 1px; width: 312px;" align="center" border="1" cellspacing="0">
                    <tr>
