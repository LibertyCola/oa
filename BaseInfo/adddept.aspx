    ...
    <body style="background-image: url(../image/rightFrame.gif)">
        <form id="form1" runat="server">
            <div>
                ...
                <br />
                <br />
                <table style="border-bottom: #006600 1px solid; border-left: #006600 1px solid; border-right: #006600 1px solid; border-top: #006600 1px solid; height: 100px; width: 400px;" align=center id="TABLE1" class="css" cellpadding="0" cellspacing="0"> 
                    <tr>
                        <td align="center" colspan="3" style="height: 20px" class="cssTitle">
                            新建部门</td>
                    </tr>
                    <tr>
                        <td style="height: 26px; width: 81px;" align="right">
                            部门名称：</td>
                    ...
                    <tr>
                        <td style="height: 26px; vertical-align: top; width: 81px;" align="right">
                            部门描述：</td>
