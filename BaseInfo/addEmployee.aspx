...
<html xmlns="http://www.w3.org/1999/xhtml" >
    ...
    <body style="background-image: url(../image/rightFrame.gif)">
        <form id="form1" runat="server">
            <div>
                <div>
                    <table style="border-bottom: #009900 1px solid; border-left: #009900 1px solid; border-right: #009900 1px solid; border-top: #009900 1px solid; height: 456px; width: 496px;" align="center" cellspacing="0" class="css" cellpadding="0">
                        <tr>
                            <td align="center" class="cssTitle" colspan="2">
                                －＝<strong>添加员工基本信息</strong>＝－</td>
                        </tr>
                        <tr>
                            <td style="height: 25px; width: 177px;" align="right">
                                员工姓名：</td>
                            <td style="height: 25px; width: 566px;">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtEName"
                                                            ErrorMessage="员工姓名　必须填写">**</asp:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                            <td style="height: 37px; vertical-align: bottom; width: 177px;" align="right">
                                员工性别：</td>
                            <td style="height: 37px; vertical-align: top; width: 566px;">
                        ...
                        <tr>
                            ...
                            <td style="height: 25px; width: 566px;">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPost"
                                                            ErrorMessage="职称　必须填写">**</asp:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                            <td style="height: 25px; width: 177px;" align="right">
                                部门：</td>
