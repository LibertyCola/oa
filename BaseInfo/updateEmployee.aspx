    ...
    <body style="background-image: url(../image/rightFrame.gif)">
        <form id="form1" runat="server">
            <div>
                ...
                <br />
                <br />
                <table align="center" style="height: 38px; width: 288px;" class="css" border="1" cellspacing="0" >
                    <tr>
                    ...
                    <tr>
                        <td style="width: 41px">
                            <asp:Label ID="Label2" runat="server" Font-Size="Small" Width="66px">员工姓名：</asp:Label></td>
                    ...
                    <tr style="color: #000000">
                        <td style="height: 21px; width: 41px;">
                            <asp:Label ID="Label3" runat="server" Font-Size="Small" Width="65px">员工性别：</asp:Label></td>
                    ...
                    <tr>
                        <td style="height: 21px; width: 41px;">
                            <asp:Label ID="Label6" runat="server" Font-Size="Small" Width="65px">员工职称：</asp:Label></td>
                        <td style="height: 21px; width: 131px;">
                            <asp:TextBox ID="txtPost" runat="server" Height="12px" Width="140px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="width: 41px">
                            <asp:Label ID="Label7" runat="server" Font-Size="Small" Width="66px">部门：</asp:Label></td>
                        <td style="width: 131px">
