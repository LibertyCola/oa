...
public partial class BaseInfo_updateEmployee : Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        Boolean bl;
        bl =
            bc.ExecSQL("update employee set name='" + txtEName.Text + "',sex='" + dlSex.Text + "',birthday='" +
                       txtEBrith.Text + "',learn='" + txtELearn.Text + "',post='" + txtPost.Text + "',dept='" +
                       dlDept.Text + "',job='" + dlJop.Text + "',tel='" + txtTel.Text + "',address='" + txtAddress.Text +
                       "',email='" + txtEmail.Text + "',state='" + dlState.Text + "' where ID='" +
